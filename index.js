...
function sumArray(array) {
  ...
  for (const index in array) {
    console.log(index);
    sum = array.reduce((sum, current) => sum + current, 0);
  }
  return sum;
...
function multiplyArray(array) {
  ...
  for (const index in array) {
    console.log(index);
    multiply = array.reduce((multiply, current) => multiply * current, 1);
  }
  return multiply; 
}
...
function printUppercase(array) {
  ...
  for (const item of array){
    console.log(item.toUpperCase(array));
  }
}
...
function multiplyByIndex(arr) {
  ...
  for (const [index, number] of arr.entries()) {
      multiplyByIndex.push(number * index);
    }
